...
var LanmeiAirlinesFlight = {
	...
	flightSelect:function(){
		...
		$('.priceTip>img').click(function(e){
			...
			// var width = $(document).width()-$(this).parent().siblings('.priceTipInfo').offset().left-$(this).parent().siblings('.priceTipInfo').width();
			// var w1 = $(this).parent().siblings('.priceTipInfo').offset().left;
			// var w2 = $(this).parent().siblings('.priceTipInfo').width();
