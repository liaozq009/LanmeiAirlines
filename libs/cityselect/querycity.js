...
;
        ...
        function resetPosition(){
            ...
            var cityBoxHeight1 = input.offset().top+input.outerHeight();
            var cityBoxHeight2 = input.offset().top+input.outerHeight();
            var left;
            if(input.attr("id")=='fromcity'){
                left = 140;
            }else{
                left = 440;
            }
             
            if(window.innerHeight-input.offset().top<230){
                cityBoxHeight1 = input.offset().top-198;
                // cityBoxHeight2 = input.offset().top-302;
            }
            if(window.innerHeight-input.offset().top<330){
                // cityBoxHeight1 = input.offset().top-200;
                cityBoxHeight2 = input.offset().top-278;
            }
            popMain.css({'top':cityBoxHeight1,'left':left});
            suggestMain.css({'top':cityBoxHeight2,'left':left});
            }
